    ...
    <div className="auth-page">
      <div className="auth-container">
        ...
        <div className="auth-card">
          <button className="btn-github-auth-dark" onClick={() => { localStorage.setItem('userFullName', 'Github Developer'); setAuthScreen('workspace'); showNotification('Sesión iniciada con GitHub!'); }}>
